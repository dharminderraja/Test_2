...
const getAvailableRestaurants = meal => {
  let restaurants = [];

  dishes.forEach(dish => {
    if (dish.availableMeals.indexOf(meal.toLowerCase()) > -1) {
      if (restaurants.indexOf(dish.restaurant) === -1) {
...
const getAvailableDishes = (meal, restaurant) => {
  let res = [];
...
export { meals, getAvailableRestaurants, getAvailableDishes };
